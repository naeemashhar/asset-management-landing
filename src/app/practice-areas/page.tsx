...
const practices = [
  {
    ...
    icon: FaLaptopCode,
    description:
      "Guiding high-growth tech firms through IPOs, M&A, and capital scaling.",
    image:
  ...
  },
  {
    ...
    icon: FaBuilding,
    description:
      "Structuring complex REITs and infrastructure funds for long-term yield.",
    image:
  ...
  },
  {
    ...
    icon: FaLeaf,
    description:
      "Financing the transition to green energy and sustainable industrial practices.",
    image:
  ...
  },
  {
    ...
    icon: FaStethoscope,
    description:
      "Capital solutions for biotech research, hospital networks, and med-tech.",
    image:
  ...
  },
  {
    ...
    icon: FaPlane,
    description:
      "Optimizing supply chain finance and fleet expansion strategies.",
    image:
  ...
  },
  {
    ...
    icon: FaIndustry,
    description:
      "Revitalizing legacy industries through modernization and efficiency capital.",
    image:
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-20 max-w-3xl mx-auto">
            <p className="text-trust-blue-600 text-lg leading-relaxed">
              We combine financial acumen with deep industry expertise. Our
              specialized practice groups understand the unique nuances,
              regulations, and value drivers of your sector.
            </p>
          </div>
