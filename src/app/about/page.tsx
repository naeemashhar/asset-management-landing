...
import { FaHandshake, FaLightbulb, FaScaleBalanced, FaUsers } from "react-icons/fa6";
...
const values = [
    {
        ...
        description: "We hold ourselves to the highest ethical standards. Trust is the currency of our business, and we earn it every day through transparent, honest counsel.",
    },
    {
        icon: FaLightbulb,
        title: "Strategic Innovation",
        description: "The financial landscape is ever-evolving. We combine time-tested principles with forward-thinking strategies to keep you ahead of the curve.",
    },
    {
        icon: FaScaleBalanced,
        title: "Client-Centricity",
        description: "Your goals are our blueprint. We don't believe in one-size-fits-all; we build bespoke solutions rigorously aligned with your specific ambitions.",
    },
    {
        icon: FaUsers,
        title: "Collaborative Excellence",
        description: "We leverage the collective intelligence of our diverse team of experts to solve complex problems and uncover unique opportunities.",
    },
];
                    ...
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 text-center divide-x divide-trust-blue-200/50">
                        {[
                            ...
                            <div key={index} className="p-4">
                                <div className="font-serif text-4xl md:text-5xl font-bold text-trust-blue-950 mb-2">
                                    {stat.value}
                                </div>
                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16 max-w-2xl mx-auto">
                        ...
                        <p className="text-trust-blue-600 leading-relaxed">
                            Our culture is defined by a relentless pursuit of excellence and an unshakeable commitment to our clients&apos; best interests.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                        {values.map((value, index) => (
                            ...
                            >
                                ...
                                <div>
                                    <h3 className="font-serif text-2xl font-bold text-trust-blue-950 mb-3">
                                        {value.title}
                                    </h3>
                                    <p className="text-trust-blue-600 leading-relaxed">
                                        {value.description}
