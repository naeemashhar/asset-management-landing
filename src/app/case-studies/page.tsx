...
const categories = ["All", "M&A", "Wealth Management", "Private Equity", "Risk Analysis"];
...
const cases = [
    ...
    },
    {
        ...
        description: "Revitalized a failing hospital network through debt restructuring and operational overhaul.",
    ...
    },
    {
        ...
        description: "Advising a logistics giant on the acquisition of an autonomous trucking startup.",
    ...
    },
    {
        ...
        description: "Implementing institutional-grade custody solutions for a family office entering the digital asset space.",
                    ...
                    <div className="flex flex-wrap justify-center gap-8 mb-20 border-b border-gray-200 pb-6">
                        {categories.map((cat) => (
                            <button
                                ...
                                className={`text-lg font-serif transition-colors duration-300 relative pb-2 ${filter === cat
                                ...
                                >
                                    ...
                                    <div className="pr-8">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <span className="text-gold-500 font-bold font-serif text-lg">
                                                {study.metric}
                                            </span>
                                        </div>

                                        <h3 className="font-serif text-3xl md:text-4xl font-bold text-trust-blue-950 mb-4 group-hover:text-trust-blue-700 transition-colors">
                                            {study.title}
                                        </h3>
                                        ...
                                        <div className="inline-flex items-center text-trust-blue-950 font-bold border-b border-transparent group-hover:border-trust-blue-950 transition-all pb-1">
                                            View Case Study <FaArrowRight className="ml-2 w-4 h-4 transform group-hover:translate-x-1 transition-transform" />
                                        </div>
                                    </div>
                                </motion.div>
                            ))}
