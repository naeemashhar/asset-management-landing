                ...
                <div className="container mx-auto px-6">
                    <div className="text-center mb-16 max-w-3xl mx-auto">
                        <p className="text-trust-blue-600 text-lg leading-relaxed">
                            Our team is composed of seasoned veterans from the world&apos;s leading financial institutions. We are united by a common purpose: to stewarding your wealth with the same care and discipline we apply to our own.
                        </p>
                    </div>
                            ...
                            >
                                <div className="relative overflow-hidden mb-6 aspect-[3/4] rounded-sm">
                                    ...
                                    <div className="absolute inset-0 bg-trust-blue-950/80 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-4">
                                        <a href="#" className="p-3 bg-gold-400 text-trust-blue-950 rounded-full hover:bg-white transition-colors">
                                            <FaLinkedinIn />
                                        </a>
                                        <a href="#" className="p-3 bg-gold-400 text-trust-blue-950 rounded-full hover:bg-white transition-colors">
                                            <FaEnvelope />
                                ...
                                <h3 className="font-serif text-2xl font-bold text-trust-blue-950 mb-1">
                                    {member.name}
                                </h3>
