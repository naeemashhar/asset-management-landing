...
const posts = [
    {
        ...
        excerpt: "With central banks adjusting policies, we analyze the impact on global asset classes and strategies for preservation.",
        date: "Feb 06, 2024",
    ...
    },
    {
        ...
        excerpt: "As traditional lending tightens, private credit is emerging as a vital source of yield for sophisticated portfolios.",
        date: "Jan 28, 2024",
    ...
    },
    {
        ...
        excerpt: "How sustainable investing is shifting from a regulatory box-ticking exercise to a core driver of long-term alpha.",
        date: "Jan 15, 2024",
    ...
    },
    {
        ...
        excerpt: "The legal and practical complexities of passing on cryptocurrency and digital property to the next generation.",
        date: "Dec 12, 2023",
    ...
    },
    {
        ...
        excerpt: "Understanding the correlation, liquidity, and valuation dynamics of fine art in a diversified portfolio.",
        date: "Nov 30, 2023",
        author: "Victoria Al-Fayed",
        category: "Lifestyle & Passion",
        image: "https://images.unsplash.com/photo-1577720580479-7d839d829c73?q=80&w=2574&auto=format&fit=crop",
    },
    {
        id: 6,
        title: "Tech Valuations: Bubble or Reset?",
        excerpt: "A deep dive into the fundamentals driving the current valuation metrics of high-growth technology firms.",
        date: "Nov 15, 2023",
        author: "Alexander von Steinberg",
                        ...
                        {posts.map((post, index) => (
                            ...
                            >
                                ...
                                <div className="p-8 flex-1 flex flex-col">
                                    ...
                                    <h3 className="font-serif text-2xl font-bold text-trust-blue-950 mb-4 group-hover:text-gold-500 transition-colors">
                                        {post.title}
                                    </h3>
