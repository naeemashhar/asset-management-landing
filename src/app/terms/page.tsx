    ...
    <div className="bg-white min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="mb-16 text-center">
          <h1 className=" font-display  text-4xl md:text-5xl font-bold text-trust-blue-950 mb-6">
            Terms of Use
          </h1>
          <LastUpdated />
        </div>
        ...
        {/* Content */}
        <div className="prose prose-lg prose-headings: font-display  prose-headings:text-trust-blue-950 prose-p:text-trust-blue-700 max-w-none">
          <p>
            Welcome to Valora. By accessing or using our website and services,
          ...
          <p>
            All content, features, and functionality regarding the Service
            (including but not limited to all information, software, text,
            displays, images, video, and audio, and the design, selection, and
            arrangement thereof) are owned by Valora, its licensors, or other
          ...
          <p>
            ...
            investment, legal, or tax advice. Valora makes no representations or
          ...
          <p>
            In no event will Valora, its affiliates, or their licensors, service
            ...
            connection with your use, or inability to use, the website or any
          ...
          <p>
            ...
            are effective immediately when we post them. Your continued use of
            the website following the posting of revised Terms means that you
