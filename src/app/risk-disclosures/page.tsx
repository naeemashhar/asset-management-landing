        ...
        <div className="bg-trust-blue-950 text-white pt-40 pb-20 px-6">
          <div className="container mx-auto max-w-4xl text-center">
            ...
            <p className="text-trust-blue-200 text-lg max-w-2xl mx-auto leading-relaxed">
              ...
              Please review the following important information regarding
              trading risks and regulatory compliance.
            </p>
          </div>
        </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-trust-blue-800 leading-relaxed">
                    All promotional materials comply with National Futures
                    Association (NFA) Compliance Rules 2-29 and 2-36 governing
            ...
            <div className="space-y-6">
              ...
              <div className="bg-gray-50 p-6 md:p-8 rounded-sm border border-gray-200 hover:border-gray-700 hover:shadow-md transition-shadow">
                ...
                <p className="text-trust-blue-800 leading-relaxed text-sm">
                  Historical performance data should be considered in context
                  with the market conditions that existed during that period.
                  The results represented in any marketing materials are not
                ...
                <div className="grid md:grid-cols-2 gap-8 lg:gap-12 text-sm text-blue-100 leading-relaxed">
                  <div className="space-y-4">
                    ...
                    <p>
                      ...
                      Trading commodity interests involves significant risk and
                      is not suitable for all investors.
                    </p>
                    <div className="bg-white/10 p-4 rounded-sm border-l-2 border-gold-400">
                      You may sustain a total loss of the premium and of any
                      additional funds you deposit with your broker to establish
                  ...
                  <div className="space-y-4">
                    ...
                    <ul className="space-y-3 list-disc pl-4 marker:text-gold-400">
                      <li>
                        If you purchase or sell a commodity futures contract or
                        sell a commodity option you may sustain a total loss of
                        the initial margin funds or security deposit.
                      </li>
                      <li>
                        You may lose any additional funds that you deposit with
            ...
            <div className="bg-white rounded-sm p-8 md:p-12 shadow-lg border-t-4 border-gold-500 relative">
              ...
              <div className="grid md:grid-cols-[1fr_2fr] gap-8 items-start">
                <div className="flex flex-col items-center text-center p-6 bg-gray-50 rounded-sm border border-gray-100">
                  ...
                  <h3 className="font-serif text-xl font-bold text-trust-blue-950 mb-2">
                    Disclosure Document
                  </h3>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-trust-blue-800 leading-relaxed text-sm">
                      ...
                      Commission (CFTC) require that prospective clients of a
                      CTA receive a disclosure document{" "}
                      <span className="font-bold text-trust-blue-950">
                        before they enter into an agreement
                      </span>{" "}
                      whereby the CTA will direct or guide the client&apos;s
                  ...
                  <div className="bg-blue-50 p-4 rounded-sm text-sm text-trust-blue-900 border-l-2 border-trust-blue-400">
                    ...
                    <p className="mb-3">
                      Valora Asset Management will provide you a copy of our
                      disclosure document at no cost. You should review our
                      disclosure document and study it carefully to determine
                      whether such trading is appropriate for you in light of
                      your financial condition.
                    </p>
                    <p className="text-xs text-trust-blue-600 italic">
                      The CFTC has not passed upon the merits of participating
                      in our trading programs nor on the adequacy or accuracy of
            ...
            <div className="pt-20 border-t border-gray-200">
              ...
              <div className="relative bg-gradient-to-br from-trust-blue-950 to-trust-blue-900 text-white p-8 md:p-12 shadow-2xl rounded-sm mb-12 overflow-hidden group">
                ...
                <div className="relative z-10 flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
                  ...
                  <div>
                    <h3 className="text-gold-400 font-bold uppercase tracking-widest text-sm mb-2">
                      Critical Warning
                    </h3>
                ...
                <div className="bg-white p-6 rounded-sm shadow-sm border border-gray-100 hover:border-gray-700 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-4 text-sm text-trust-blue-700 leading-relaxed">
                    <p className="font-medium text-trust-blue-900">
                      ...
                      RESULTS. THE RISK OF LOSS IN TRADING COMMODITY FUTURES,
                      OPTIONS, AND FOREIGN EXCHANGE (&quot;FOREX&quot;) IS
                      SUBSTANTIAL.
                    </p>
                    <p>
                      You should carefully consider whether such trading is
                      ...
                      commodity futures, options, and forex trading can work
                    ...
                    <p>
                      ...
                      else to trade for you, you should be aware of the
                      following: If you purchase a commodity option you may
                      sustain a total loss of the premium and of any additional
                      funds you deposit with your broker to establish or
                ...
                <div className="bg-white p-6 rounded-sm shadow-sm border border-gray-100 hover:border-gray-700 hover:shadow-md transition-shadow">
                  ...
                  <div className="space-y-4 text-sm text-trust-blue-700 leading-relaxed">
                    <p>
                      If you purchase or sell a commodity futures contract or
                      sell a commodity option you may sustain a total loss of
                      the initial margin funds or security deposit and any
                      additional funds that you deposit with your broker to
                      establish or maintain your position.
                    </p>
                    <p>
                      ...
                      requested funds within the prescribed time, your position
                      may be liquidated at a loss, and you will be liable for
              ...
              <div className="space-y-6 mt-6">
                ...
                <div className="relative overflow-hidden bg-yellow-50 rounded-sm border-l-4 border-gold-500 p-8 shadow-sm">
                  <p className="font-bold text-trust-blue-950 uppercase leading-loose text-sm md:text-[15px] tracking-wide text-justify">
                    ...
                    RESULTS, CUSTOMERS SHOULD BE PARTICULARLY WARY OF PLACING
                    UNDUE RELIANCE ON THESE HYPOTHETICAL PERFORMANCE RESULTS.
                  </p>
                </div>
              </div>
              ...
              <div className="font-bold mt-12 pt-6 border-t border-gray-200 flex flex-col justify-between items-center text-xs text-gray-800 gap-1">
                <p>
                  © 2026 Valora Asset Management. All Rights Reserved. | NFA
                  Registered CTA
                </p>
