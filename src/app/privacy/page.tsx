    ...
    <div className="bg-gray-200 min-h-screen pt-32 pb-20">
      <div className="container mx-auto px-6 max-w-4xl">
        ...
        <div className="prose prose-lg prose-headings: font-display  prose-headings:text-trust-blue-950 prose-p:text-trust-blue-700 max-w-none">
          <p>
            At Valora, we value your privacy and are committed to protecting
          ...
          <ul className="list-disc pl-6 space-y-2 mb-8">
            <li>
              <strong>Personal Identity Information:</strong> Name, email
              address, phone number, etc.
            </li>
            <li>
              <strong>Financial Information:</strong> Data necessary to process
              your investment profile (collected securely).
            </li>
            <li>
              <strong>Usage Data:</strong> Information on how you access and use
              our services (e.g., page views, time spent).
            </li>
          </ul>
          ...
          <p>
            ...
            us at:{" "}
            <a
              href="mailto:legal@valoraam.com"
