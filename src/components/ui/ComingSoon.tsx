...
export default function ComingSoon({ title }: { title: string }) {
  return (
    <div className="min-h-[70vh] flex flex-col items-center justify-center bg-gray-50 text-center px-6">
      ...
      <h1 className=" font-display  text-4xl md:text-6xl font-bold text-trust-blue-950 mb-6">
        {title}
      </h1>
      <p className="text-trust-blue-600 max-w-lg mb-10 text-lg">
        We are crafting a premium experience for this section. Please check back
        soon or contact us for immediate assistance.
      </p>
      <Link href="/">
