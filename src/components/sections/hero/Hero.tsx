  ...
  return (
    ...
    >
      ...
      <div className="container relative z-10 px-6 mx-auto flex flex-col items-center text-center">
        ...
        <h1 className="font-display text-5xl uppercase md:text-6xl lg:text-7xl font-bold leading-tight mb-8 tracking-tight">
          <motion.span
          ...
          <span className="block mb-5 h-[1.4em] overflow-hidden pb-2 -mb-2">
            <AnimatePresence mode="wait">
              <motion.span
                ...
                className="block bg-gradient-to-r from-gold-200 via-gold-500 to-gold-200 bg-clip-text text-transparent"
              >
