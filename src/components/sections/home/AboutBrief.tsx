...
export default function AboutBrief() {
    ...
    return (
        <section ref={ref} className="py-24 bg-white overflow-hidden w-[90%] mx-auto">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
                    ...
                    <div className="lg:col-span-5 flex flex-col justify-center">
                        ...
                        <motion.h2
                            ...
                            className="font-serif text-4xl md:text-5xl font-bold text-trust-blue-950 mb-8 leading-tight"
                        >
                        ...
                        >
                            <a href="/about" className="inline-flex items-center text-trust-blue-950 font-bold border-b-2 border-gold-400 hover:text-gold-500 transition-colors pb-1">
                                About us
                            </a>
                        </motion.div>
                    </div>
                    ...
                    <div className="lg:col-span-3 flex flex-col justify-center pl-0 lg:pl-10 relative">
                        {stats.map((stat, index) => (
                            <div key={index} className="relative py-8 first:pt-0 border-b border-gray-200 last:border-0">
                                ...
                                >
                                    <span className="block text-5xl font-bold text-trust-blue-950 mb-2 font-serif">
                                        {stat.value}
                                    </span>
