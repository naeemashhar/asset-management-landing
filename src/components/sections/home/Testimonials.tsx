...
const testimonials = [
  {
    id: 1,
    quote:
      "Valora's strategic insight completely transformed our approach to risk management. They don't just advise; they partner in your success.",
    author: "Elena V.",
  ...
  },
  {
    id: 2,
    quote:
      "The depth of market analysis provided was instrumental in our recent merger. Exceptional professionalism and clarity.",
    author: "Marcus T.",
  ...
  },
  {
    id: 3,
    quote:
      "A rare combination of analytical rigor and creative financial problem-solving. They curated a legacy plan that secured our family's future.",
    author: "Sarah L.",
          ...
          <div className="w-full md:w-2/3 relative min-h-[300px]">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <p className=" font-display  text-2xl md:text-3xl leading-relaxed mb-8 relative z-10">
            ...
            >
              ...
              {[...clients, ...clients, ...clients, ...clients].map(
                (client, i) => (
                  <span
                    key={i}
                    className=" font-display  text-2xl md:text-3xl font-bold text-white/40 hover:text-white/80 transition-colors cursor-default"
                  >
                    {client}
                  </span>
                ),
